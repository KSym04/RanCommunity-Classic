...
CNPCContributionShopWindow::CNPCContributionShopWindow()
	: m_pListTextBox(NULL), m_pListScrollBar(NULL), m_pTextPage(NULL), m_pTextStaticContribution(NULL), m_pTextCharContribution(NULL), m_pTextStaticMoney(NULL), m_pTextCharMoney(NULL), m_pButtonPurchase(NULL), m_pButtonPrev(NULL), m_pButtonNext(NULL), m_pBuyConfirm(NULL), m_pBuyConfirmText(NULL)

	  ,
	  m_nSelectIndexType(-1), m_nCurrentPage(1), m_sSelectItem(NATIVEID_NULL()), m_sCrow(NATIVEID_NULL()), m_nMaxPage(1)
{
