...
CNPCShopWindow::CNPCShopWindow()
	: m_pListTextBox(NULL), m_pListScrollBar(NULL), m_pButtonPurchase(NULL), m_pButtonPrev(NULL), m_pButtonNext(NULL), m_pTextPage(NULL), m_pTextStaticMoney(NULL), m_pTextCharMoney(NULL), m_pBuyConfirm(NULL), m_pBuyConfirmText(NULL), m_nSelectIndexType(-1), m_nCurrentPage(1), m_sSelectItem(NATIVEID_NULL()), m_sCrow(NATIVEID_NULL()), m_wShopType(0), m_nMaxPage(1)
{
