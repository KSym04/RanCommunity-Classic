...
CBattlePassPage::CBattlePassPage()
	: m_pTextMissionTitle(NULL), m_pTextRewardTitle(NULL), m_pBattlePassList(NULL), m_pBattlePassReward(NULL)
{
}
...
{
	if (m_pBattlePassList)
		m_pBattlePassList->ResetData();
	if (m_pBattlePassReward)
		m_pBattlePassReward->ResetData();
