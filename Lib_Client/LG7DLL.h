...
#define GLOBAL_RANKING_SIZE	9	//4class	// add /*Top MMR, Mhundz */
...
/*Top Level*/
typedef std::vector<STOP_RANK_LEVEL>	VEC_TOP_LEVEL;
typedef VEC_TOP_LEVEL::iterator			VEC_TOP_LEVEL_ITER;
