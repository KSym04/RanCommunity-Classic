...
// Trade Success with Name, JDevelopments, 7/14/2025
BOOL GLTradeClient::MsgTradeCompleteTar(NET_MSG_GENERIC* nmg)
{
	...
	CString strMsg;
	strMsg.Format("Trade successfully to [%s]", pNetMsg->szTargetName);
	CInnerInterface::GetInstance().PrintMsgText(NS_UITEXTCOLOR::PALEGREEN, strMsg);
