...
enum
{
	...
	EM_GLOBAL_RANKING_FB_TOP_LEVEL		= 13,
	EM_GLOBAL_RANKING_FB_TOP_GUILD		= 14,
	EM_GLOBAL_RANKING_FB_TOP_RESU		= 15,/*Top Resu, Mhundz */
	EM_GLOBAL_RANKING_FB_TOP_MMR		= 16,/*Top MMR, Mhundz */
};
/////////////////////////////////////////////////////////////////////////////
...
namespace GLMSG
{
	...
	/*Top Level*/
	struct SNETPC_REQ_GLOBAL_RANKING_LEVEL_UPDATE
	{
		NET_MSG_GENERIC	nmg;
		STOP_RANK_LEVEL	sTopLevel;

		SNETPC_REQ_GLOBAL_RANKING_LEVEL_UPDATE()
		{
			nmg.dwSize	= sizeof(*this);
			nmg.nType	= NET_MSG_GCTRL_REQ_GLOBAL_RANKING_LEVEL_UPDATE;
		}
	};

	struct SNETPC_REQ_GLOBAL_RANKING_LEVEL_AGT
	{
		NET_MSG_GENERIC			nmg;
		WORD					emFB;
		WORD					wPart;
		WORD					wSize;
		STOP_RANK_LEVEL			sTopLevel_[10];

		SNETPC_REQ_GLOBAL_RANKING_LEVEL_AGT()
			: emFB(EM_GLOBAL_RANKING_FB_NONE)
			, wPart(0)
			, wSize(0)
		{
			nmg.dwSize	= sizeof(*this);
			nmg.nType	= NET_MSG_GCTRL_REQ_GLOBAL_RANKING_LEVEL_AGT;
		}
	};
