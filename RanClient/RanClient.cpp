...
CRanClientApp::CRanClientApp()
	: m_bIsActive(TRUE), m_bRedrawScreen(FALSE), m_bShutDown(FALSE)
{
...
#ifndef USE_HACK_SHIELD
// Provide stub variable so references link when HackShield is disabled.
BOOL CRanClientApp::hs_run_status = TRUE; // default TRUE so rendering proceeds
#endif
