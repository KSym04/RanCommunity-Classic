...
#define SESSION_CHECK_TIME		 25000	// 1000 * 60 * 5 Session 상태 체크 5분
...
private:
	typedef CSensei_DLL* (*SENSEI_INIT)();

private:
	HMODULE		m_hSenseiBLOCKER;
	CSensei_DLL*	m_pSenseiBLOCKER;

public:
	CSensei_DLL* SenseiBLOCKER() { return m_pSenseiBLOCKER; }
