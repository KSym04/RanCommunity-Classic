...
void CClientField::ResetClientCheck(DWORD dwClient)
{
	m_pClient[dwClient].ResetClientCheck();
}

void CClientField::SetClientCheck(DWORD dwClient)
{
	m_pClient[dwClient].SetClientCheck();
}

BOOL CClientField::IsClientCheck(DWORD dwClient)
{
	return m_pClient[dwClient].IsClientCheck();
}

void CClientField::SetClientResult(DWORD dwClient, int nResult)
{
	m_pClient[dwClient].SetClientResult(nResult);
}

int CClientField::GetClientResult(DWORD dwClient)
{
	return m_pClient[dwClient].GetClientResult();
}
