...
public:
	...
	void* getRcvMsg( bool bClient, bool &bBlocked );
	...
	void	SetClientValid		()		{ m_bValid = true; }
	bool	GetValidClient		()		{ return m_bValid; }
	...
	void	SetBlocked()	{	m_bBlocked = true;   }
...
public:
	...
	void ResetClientCheck()				{ m_bClientCheck = FALSE; }
	void SetClientCheck()				{ m_bClientCheck = TRUE; }
	BOOL IsClientCheck()				{ return m_bClientCheck; }
	void SetClientResult(int nResult)	{ m_nResult = nResult; }
	int GetClientResult()				{ return m_nResult; }
