								   ...
								   SCHARDATA2 *pChaData2)
{
	...
	SQLCHAR szChaName[CHR_ID_LENGTH + 1] = {0};
	SQLINTEGER cbChaName = SQL_NTS; // 캐릭터명
	SQLCHAR szChaGuName[CHAR_SZNAME + 1] = {0};
	SQLINTEGER cbChaGuName = SQL_NTS; // 클럽에서의 닉네임
	...
	SQLFLOAT fChaPosX = 0;
	SQLINTEGER cbChaPosX = SQL_NTS;
	SQLFLOAT fChaPosY = 0;
	SQLINTEGER cbChaPosY = SQL_NTS;
	SQLFLOAT fChaPosZ = 0;
	SQLINTEGER cbChaPosZ = SQL_NTS;
	...
	SQLFLOAT fChaSavePosX = 0;
	SQLINTEGER cbChaSavePosX = SQL_NTS;
	SQLFLOAT fChaSavePosY = 0;
	SQLINTEGER cbChaSavePosY = SQL_NTS;
	SQLFLOAT fChaSavePosZ = 0;
	SQLINTEGER cbChaSavePosZ = SQL_NTS;
	...
	SQLSMALLINT nChaSex = 0;
	SQLINTEGER cbChaSex = SQL_NTS;
	...
	SQLINTEGER nChaInvenLine = 0;
	SQLINTEGER cbChaInvenLine = SQL_NTS;
	SQLINTEGER nGuNum = 0;
	SQLINTEGER cbGuNum = SQL_NTS;

	SQLINTEGER nChaReturnMap = 0;
	SQLINTEGER cbChaReturnMap = SQL_NTS;
	SQLFLOAT fChaReturnPosX = 0;
	SQLINTEGER cbChaReturnPosX = SQL_NTS;
	SQLFLOAT fChaReturnPosY = 0;
	SQLINTEGER cbChaReturnPosY = SQL_NTS;
	SQLFLOAT fChaReturnPosZ = 0;
	SQLINTEGER cbChaReturnPosZ = SQL_NTS;
	...
	SQLFLOAT fChaScaleRange = 0;
	SQLINTEGER cbChaScaleRange = SQL_NTS;
	...
	SQLCHAR szChaBadge[CHAR_SZNAME + 1] = {0};
	SQLINTEGER cbChaBadge = SQL_NTS;
	...
	while (true)
	{
		...
		if (sReturn == SQL_SUCCESS || sReturn == SQL_SUCCESS_WITH_INFO)
		{
			...
			/* Gacha System, MontageDev 7/10/24 */
			pChaData2->m_wGachaPromisePoint = (WORD)nGachaPromisePoint;
	...
	TCHAR *szPhoneNumber)
{
	...
	SQLCHAR szChaPhNum[SMS_RECEIVER] = {0};
	SQLINTEGER cbChaPhNum = SQL_NTS;
	...
	SCHARDATA2 *pChaData2)
{
	SQLRETURN sReturn = 0;
	{
		...
		SQLCHAR szTempMoney[CHAR_TEMPMONEY] = {0};
		SQLINTEGER cbTempMoney = SQL_NTS;
		SQLINTEGER nChaLevel = 0, cbChaLevel = SQL_NTS;
