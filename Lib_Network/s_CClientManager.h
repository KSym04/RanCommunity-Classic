...
public:
	...
	bool    ClientCheck			(DWORD dwClient);
	void    ClientsCheck		();
	WORD    IPCount				(char *pszIP, DWORD dwClient);
	...
	void* getRcvMsg(DWORD dwClient,bool bClient,bool& bBlocked);
	...
	DWORD   GetClientID			(DWORD dwChaNum);
