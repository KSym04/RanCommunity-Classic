...
public :
	...
	void*	getRcvMsg(DWORD dwClient,bool &bBlocked);
	...
	void	SetClientValid (DWORD dwClient);
	bool	GetValidClient (DWORD dwClient);
	...
	*/
	...
	void ResetClientCheck(DWORD dwClient);
	void SetClientCheck(DWORD dwClient);
	BOOL IsClientCheck(DWORD dwClient);
	void SetClientResult(DWORD dwClient, int nResult);
	int GetClientResult(DWORD dwClient);
