...
#include <Windows.h>
    ...
    const Entry *Parser::parseEntry()
    {
        ...
        else if (entry_.type == DMI_TYPE_SYSINFO)
        {
            // 2.0+
            if (version_ >= SMBIOS_2_0)
            {
        ...
        else if (entry_.type == DMI_TYPE_BASEBOARD)
        {
            // 2.0+
            if (version_ >= SMBIOS_2_0)
            {
        ...
        else if (entry_.type == DMI_TYPE_SYSENCLOSURE)
        {
            // 2.0+
            if (version_ >= SMBIOS_2_0)
            {
        ...
        else if (entry_.type == DMI_TYPE_SYSSLOT)
        {
            // 2.0+
            if (version_ >= smbios::SMBIOS_2_0)
            {
        ...
        else if (entry_.type == DMI_TYPE_PHYSMEM)
        {
            // 2.1+
            if (version_ >= smbios::SMBIOS_2_1)
            {
